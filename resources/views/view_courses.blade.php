                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                @php
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$material->course->class_no}}</td>
                                        <td>
                                            <a href="{{Url('/view_course_material/'.$material->course_id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 5px" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>  
                                    @php
                                    $count++;
