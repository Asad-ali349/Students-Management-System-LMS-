	...
	<body>
							...
							<div class="user-profile layout-spacing">
								<div class="widget-content widget-content-area">
									<div class="d-flex justify-content-between">
										<h4 class="" style="margin:5px;border-bottom: 2px solid #057485; ">Material Detail </h4>
									</div>
                                    <div class="row p-3">
										
                                        <div class="col-md-12">
                                            <span><strong style="color:black">Course Name: </strong> {{$material->course_detail->name}}</span>
                                        </div>
                                        <div class="col-md-12">
                                            <span><strong style="color:black">Class No: </strong>
											{{$material->course_detail->class_no}}
											</span>
                                        </div>
                                        <div class="col-md-12">
                                            <span><strong style="color:black">Uploaded Date: </strong>
												@php
													$d=$material->created_at;
                                        ...
                                        <div class="col-md-12">
                                            <span><strong style="color:black">Description: </strong> {{$material->description}}</span>
                                        </div>
                                    </div>
								</div>
							</div>
							...
							<div class="row mb-5">
								<div class="col-lg-12 col-12 ">
									<div class="statbox widget box box-shadow mb-4">
										...
										<form action="{{url('/admin/uplaod_material_docs')}}" enctype="multipart/form-data" class="dropzone" id="dropzonewidget">
											</form>
										</div>
									</div>
								</div>
                                    ...
                                    <div class="widget-content widget-content-area br-6 ">
                                        ...
                                        <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$count}}</td>
                                                    <td><a target="blank" href="{{asset('storage/app/'.$docs->document)}}" download="{{$docs->document}}">{{$docs->document}}</a></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a onclick="delete_doc({{$docs->id}})"><i class="far fa-times-circle" style="color: red; font-size: 18px;" aria-hidden="true"></i></a>
                                                    </td>
                                                </tr>
												@php
												 $count++;
		...
		<script>
			function delete_doc(id){
				...
				$.get('delete_material_docs/'+id).then((result)=>{
					Swal.fire({
						position: 'top-end',
						icon: result.type,
						title: result.msg,
		...
		<script>
			...
			myDropzone.on("sending", function(file, xhr, formData) {
					...
					formData.append("helping_material_id","{{$material->id}}");
			}); 
