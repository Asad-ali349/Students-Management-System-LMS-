                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$material->course_class}}</td>
                                        <td><span class="shadow-none badge badge-primary">{{$material->count}}</td>
                                        <td>
                                            <a href="{{Url('admin/view_course_material/'.$material->course_id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 5px" aria-hidden="true"></i></a>
                                            <a href="{{Url('admin/delete_all_material/'.$material->course_id)}}"><i class="far fa-times-circle" style="color: red; font-size: 18px;" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>  
                                    @php
                                    $count++;
