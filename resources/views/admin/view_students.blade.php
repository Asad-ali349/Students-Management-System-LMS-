                    ...
                    <div class=" widget-content widget-content-area br-6">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>4</td>
                                <td>
                                    <a href="{{Url('admin/student_details/'.$student->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                    <a href="{{Url('admin/edit_student/'.$student->id)}}"><i class="far fa-edit" style="color: blue; font-size: 18px;margin-right: 5px" aria-hidden="true"></i></a>
                                    <a href="{{Url('admin/delete_student/'.$student->id)}}" onclick="return confirm('Are You Sure to Delete')"><i class="far fa-times-circle" style="color: red; font-size: 18px;" aria-hidden="true"></i></a>
