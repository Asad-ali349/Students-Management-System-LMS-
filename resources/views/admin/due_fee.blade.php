    ...
    @include('admin.includes.navbar')
        ...
        <div id="content" class="main-content">
            ...
            @if(session('success_msg'))
                ...
                @endif    
                        <div class="col-lg-12 col-12 layout-spacing mb-4">
                            <form action="{{url('/admin/make_fee_invoice')}}" method="GET">
                                <button class="btn btn-primary " style="float:right">Create invoices</button>
                            </form>
                        </div>    
                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{Url('admin/update_invoice_status/'.$invoice->id)}}" onclick="return confirm('Are Your sure?')"><i class="fa fa-check-circle" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    @php
                                    $count++;
