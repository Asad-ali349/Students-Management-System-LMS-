                        ...
                        <div class="col-lg-12 col-12 layout-spacing">
                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$count}}</td>
                                        <td>{{$material->course_detail->name}}</td>
                                        <td>
                                            @php
                                        ...
                                        <td>
                                            <a href="{{Url('admin/material_detail/'.$material->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 5px" aria-hidden="true"></i></a>
                                            <a href="{{Url('admin/delete_material/'.$material->id)}}"><i class="far fa-times-circle" style="color: red; font-size: 18px;" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
