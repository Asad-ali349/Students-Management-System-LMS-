                    ...
                    <div class=" widget-content widget-content-area br-6">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>Quiz Name</th>
                                <th>Course Name</th>
                                <th class="dt-no-sorting">Class No</th>
                                <th class="dt-no-sorting">Total Marks</th>
                                <th class="dt-no-sorting">Conduct Date</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$count}}</td>
                                <td>{{$quiz->name}} </td>
                                <td>{{$quiz->course_detail->name}}</td>
                                <td>{{$quiz->course_detail->class_no}}</td>
                                ...
                                <td>
                                    <a href="{{Url('admin/quiz_detail/'.$quiz->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                    <a href="{{Url('/admin/edit_quiz/'.$quiz->id)}}"><i class="far fa-edit" style="color: blue; font-size: 18px;margin-right: 5px" aria-hidden="true"></i></a>
                                    <a href="{{Url('admin/delete_quiz/'.$quiz->id)}}" onclick="return confirm('Are You Sure to Delete')"><i class="far fa-times-circle" style="color: red; font-size: 18px;" aria-hidden="true"></i></a>
