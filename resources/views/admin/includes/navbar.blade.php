        ...
        <div class="sidebar-wrapper sidebar-theme" >
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu ">
                        <a href="{{Url('admin/dashboard')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{Url('admin/profile')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="#student" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle" id="two">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled" id="student" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="{{Url('admin/view_students')}}"> View Students</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        <a href="#course" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle" id="two">
                            <div class="">
                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                <span>Courses</span>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled" id="course" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="{{Url('admin/view_courses')}}"> View Courses</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="fee" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('admin/due_fee')}}"> Due</a>
                            </li>
                            <li>
                                <a href="{{Url('admin/paid_fee')}}"> Paid</a>
                            </li>
                            
                        </ul>
                    </li>
                    <li class="menu">
                        <a href="{{Url('admin/course_enrollment')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="usernotes" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('admin/add_quiz')}}"> Add Quiz</a>
                            </li>
                            <li>
                                <a href="{{Url('admin/view_quiz')}}"> View Quiz</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        <a href="#Material" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle" id="two">
                            <div class="">
                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect></svg>
                        ...
                        <ul class="collapse submenu list-unstyled" id="Material" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('admin/add_material')}}"> Add Material</a>
                            </li>
                            <li>
                                <a href="{{Url('admin/view_materials')}}"> View Material</a>
                            </li>
                        </ul>
                    </li>
