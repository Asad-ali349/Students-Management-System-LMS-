                            ...
                            <div class="col-lg-12 col-12 layout-spacing">       
                                <div class="statbox widget box box-shadow">
                                    ...
                                    <div class="ml-2 row">
                                        ...
                                        <div class="col-md-6">
                                            <span><strong style="color:black">Student Class No</strong> : 4</span>
                                        </div>
                            ...
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{Url('quiz_detail/'.$quiz->quiz_id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                        </td>
